...
_io = [
    # Clk / Rst
    ("clk", 0, Pins("K17"), IOStandard("LVCMOS33")),
    ("cpu_reset", 0, Pins("Y16"), IOStandard("LVCMOS33")),

    # Leds
    ("led", 0, Pins("M14"), IOStandard("LVCMOS33")),
    ("led", 1, Pins("M15"), IOStandard("LVCMOS33")),
    ("led", 2, Pins("G14"), IOStandard("LVCMOS33")),
    ("led", 3, Pins("D18"), IOStandard("LVCMOS33")),
   ...
   # infrarrojo
    ...
    # Switches
    ("sw", 0, Pins("G15"), IOStandard("LVCMOS33")),
    ("sw", 1, Pins("P15"), IOStandard("LVCMOS33")),
    ("sw", 2, Pins("W13"), IOStandard("LVCMOS33")),
...
class Platform(XilinxPlatform):
    ...
    def do_finalize(self, fragment):
        ...
        self.add_period_constraint(self.lookup_request("clk", loose=True), 1e9/125e6)
