...
/* GPIO_infra */
#define CSR_GPIO_INFRA_BASE (CSR_BASE + 0x2000L)
#define CSR_GPIO_INFRA_IN_ADDR (CSR_BASE + 0x2000L)
#define CSR_GPIO_INFRA_IN_SIZE 1
static inline uint32_t GPIO_infra_in_read(void) {
	return csr_read_simple((CSR_BASE + 0x2000L));
}

/* PWM */
#define CSR_PWM_BASE (CSR_BASE + 0x2800L)
#define CSR_PWM_ENABLE_ADDR (CSR_BASE + 0x2800L)
...
#define CSR_PWM_WIDTH_ADDR (CSR_BASE + 0x2804L)
...
#define CSR_PWM_PERIOD_ADDR (CSR_BASE + 0x2808L)
